...
import com.abdelaziz26.metriplate.enums.workout.DayStatus;
...
public class DailyPlanMapper {
    ...
    private MealDTO toMealDto(DailyPlanMeal dailyPlanMeal) {
        ...
        mealDto.setId(dailyPlanMeal.getMeal().getId());
        mealDto.setOrder(dailyPlanMeal.getMealOrder());
    ...
    private IngredientDTO toIngredientDto(MealIngredient mealIngredient) {
        ...
        ingredientDto.setIngredientId(mealIngredient.getIngredient().getId());
