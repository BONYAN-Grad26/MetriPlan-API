...
public class GeminiService implements AiService {
    ...
    public GeminiService(ChatClient.Builder chatClient,
                         ...
                         GoalRepository goalRepository, SecurityContextService securityContextService, PlanService planService) {
    ...
    @Override
    @Transactional
    public DietPlan generateAndSaveDietPlan() throws PlanGenerationException {
        ...
        Goal goal = user.getGoals().getLast();
        ...
        return planService.persistPlans(response.getDietPlan(), user, goal);
    }
